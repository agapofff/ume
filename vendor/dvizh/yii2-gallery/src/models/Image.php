...
class Image extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'title' => Yii::t('back', 'Подпись (Атрибут Title)'),
            'description' => Yii::t('back', 'Описание'),
            'gallery_id' => Yii::t('back', 'ID галереи'),
            'sort' => Yii::t('back', 'Порядок'),
            'alt' => Yii::t('back', 'Альтернативная подпись (Атрибут Alt)'),
            'filePath' => Yii::t('back', 'Путь'),
            'itemId' => Yii::t('back', 'ID'),
            'isMain' => Yii::t('back', 'Главное'),
            'modelName' => Yii::t('back', 'Модель'),
            'urlAlias' => Yii::t('back', 'Алиас'),
        ];
    }
}
