...
<div class="paymenttype-form">
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <p class="hidden"><?=Yii::t('back', 'Widget call automacly'); ?>:</p>
        
        <pre class="hidden">widgetPath::widget([
    'autoSend' => true,
    'orderModel' => $model,
    'description' => 1,
])</pre>
        <p class="hidden"><?=Yii::t('back', 'Example')?>: <a href="https://github.com/dvizh/yii2-paymaster">dvizh/yii2-paymaster</a></p>
    ...
    ?>
            <div role="tabpanel" class="tab-pane <?php if ($lang->code == Yii::$app->language){?>active<?php } ?>" id="description_<?= $lang->code ?>_tab" style="padding-left: 0; padding-right: 0;">
                <?= \yii\imperavi\Widget::widget([
                        'id' => 'paymenttype-description_'.$lang->code,
