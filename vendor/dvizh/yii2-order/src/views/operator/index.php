...
$this->title = Yii::t('back', 'Operator area');
    ...
    if($column == 'payment_type_id') {
        $column = [
            ...
            'filter' => Html::activeDropDownList(
                ...
                'payment_type_id',
                $paymentTypes,
                ['class' => 'form-control', 'prompt' => Yii::t('back', 'Payment type')]
            ),
        ...
        $column = [
            ...
            'filter' => Html::activeDropDownList(
                ...
                'shipping_type_id',
                $shippingTypes,
                ['class' => 'form-control', 'prompt' => Yii::t('back', 'Shipping type')]
            ),
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?=Yii::t('back', 'Order'); ?></h4>
      </div>
