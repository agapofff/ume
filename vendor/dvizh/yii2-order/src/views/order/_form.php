        ...
        <div class="row">
            <div class="col-lg-6">
                <div class=" panel panel-default">
                    <div class="panel-heading"><h3><?=Yii::t('back', 'Order');?></h3></div>
                    <div class="panel-body">
                        ...
                        <div class="form-group offer">
                            <?= Html::submitButton($model->isNewRecord ? Yii::t('back', 'Create order') : Yii::t('back', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
                        </div>
                    </div>
                </div>
            </div>
