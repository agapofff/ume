    ...
    public function actionRequest()
    {
        ...
        if ($model->load(\Yii::$app->request->post()) && $model->sendRecoveryMessage()) {
            ...
            return $this->render('/message', [
                'title'  => Yii::t('front', 'Письмо для восстановления доступа к Вашей учётной записи отправлено на Ваш e-mail'),
                'module' => $this->module,
            ]);
        }
    ...
    public function actionReset($id, $code)
    {
        ...
        if ($token === null || $token->isExpired || $token->user === null) {
            ...
            \Yii::$app->session->setFlash(
                'danger',
                Yii::t('front', 'Ссылка для восстановления некорректна или устарела. Пожалуйста, попробуйте запросить новую ссылку для восстановления.')
            );
            return $this->render('/message', [
                'title'  => Yii::t('front', 'Ссылка некорректна или устарела'),
                'module' => $this->module,
            ]);
        }
        ...
        if ($model->load(\Yii::$app->getRequest()->post()) && $model->resetPassword($token)) {
            ...
            return $this->render('/message', [
                'title'  => Yii::t('front', 'Пароль был изменён'),
                'module' => $this->module,
            ]);
        }
