...
console.log(option);
                        ...
                        if (shippingType == 'pickups') {
                            ...
                            $.each(data.pickups, function (k, pickup) {
                                ...
                                $('#pickupsList').append('<div class=\"col-6\"><div class=\"select-pickup border rounded-lg pt-1 px-1_5 h-100 cursor-pointer ' + (k ? '' : ' border-primary') + '\" data-id=\"' + pickup.id + '\"><div class=\"row h-100\"><div class=\"col-12\"><p class=\"font-weight-bold\">' + pickup.text +'</p></div><div class=\"col-12 align-self-end\"><p><a class=\"btn btn-link show-map text-dark px-0 text-underline d-flex\" data-toggle=\"lightbox\" href=\"https://maps.google.com/maps?width=100%&height=500&hl=" . Yii::$app->language . "&q=' + pickupData.lat + ',' + pickupData.lon + '&t=&z=16&ie=UTF8&iwloc=B&output=embed\" data-title=\"' + pickupData.delivery_service.name + '\" data-max-height=\"510\">" . Yii::t('front', 'Посмотреть на карте') . "</a></p></div></div></div>');
                            });
                        }
