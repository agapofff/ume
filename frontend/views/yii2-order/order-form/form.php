...
console.log(option);
                        ...
                        if (shippingType == 'pickups') {
                            ...
                            $.each(data.pickups, function (k, pickup) {
                                ...
                                $('#pickupsList').append('<div class=\"col-6\"><div class=\"select-pickip border rounded-lg pt-1 px-1_5 h-100' + (k ? '' : ' border-primary') + '\" data-id=\"' + pickup.id + '\"><div class=\"row\"><div class=\"col-12\"><p class=\"font-weight-bold\">' + pickup.text +'</p></div><div class=\"col-12 align-self-end\"><p class=\"show-map\"><button type=\"button\" class=\"btn btn-link text-dark px-0\" data-toggle=\"lightbox\" data-remote=\"https://maps.google.com/maps?width=100%&height=500&hl=" . Yii::$app->language . "&q=' + pickupData.lat + ',' + pickupData.lon + '&t=&z=16&ie=UTF8&iwloc=B&output=embed\" data-title=\"' + pickupData.delivery_service.name + '\" data-width=\"100%\" data-height=\"400\">" . Yii::t('front', 'Посмотреть на карте') . "</button></p></div></div></div>');
                            });
                        }
