    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title"><?=Yii::t('back', 'Create order');?></h4>
            </div>
...
<?php } ?>
                <div class="dvizh_order_oneclick_form">
                    <?php $form = ActiveForm::begin(['action' => Url::toRoute(['/order/tools/one-click'])]); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6"><?= $form->field($orderModel, 'client_name')->label(Yii::t('back', 'How call you?'))->textInput(['required' => true]) ?></div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?= Html::submitButton(Yii::t('back', 'Create order'), ['class' => 'btn btn-success']) ?>
                            </div>
                        </div>
                    <?php ActiveForm::end(); ?>
                </div>
