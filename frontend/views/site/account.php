...
?>
    ...
    ?>
            <div class="row cursor-pointer" data-toggle="lightbox" data-remote="<?= Url::to(['/orders/' . $order->id], true) ?> #order-content" data-title="<?= Yii::t('front', 'Заказ') ?> №<?= $order->id ?>" data-modal-dialog-class="modal-dialog-scrollable">
