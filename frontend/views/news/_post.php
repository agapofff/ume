...
<a href="<?= Url::to(['/news/' . $post->slug]) ?>" class="news-post card rounded-0 border-gray-800 mb-2 transition text-dark">
    ...
    <div class="card-img-overlay p-1_5">
        ...
        <p class="mb-0 lead text-white d-md-none d-xl-block">
